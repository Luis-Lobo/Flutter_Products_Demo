...
// in flutter_products_demo/test/src/features/authentication/presentation/business_components/authentication_cubit_test.dart.
...
class AuthenticationUseCaseMock extends _i1.Mock
    implements _i4.AuthenticationUseCase {
  AuthenticationUseCaseMock() {
  ...
  @override
  _i5.Future<_i7.UserModel?> getUser() => (super.noSuchMethod(
        Invocation.method(
          #getUser,
          [],
        ),
  ...
  @override
  _i5.Future<void> logout(_i2.BuildContext? context) => (super.noSuchMethod(
        Invocation.method(
          #logout,
          [context],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class AutenticationRepositoryMock extends _i1.Mock
    implements _i8.AuthenticationRepository {
  AutenticationRepositoryMock() {
    _i1.throwOnMissingStub(this);
  }
