...
// in flutter_products_demo/test/src/features/products/presentations/business_components/product_cubit_test.dart.
...
class ProductsUseCaseMock extends _i1.Mock implements _i3.ProductsUseCase {
  ProductsUseCaseMock() {
  ...
  @override
  _i4.Future<_i2.ProductModel> getProduct({required int? id}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getProduct,
          [],
